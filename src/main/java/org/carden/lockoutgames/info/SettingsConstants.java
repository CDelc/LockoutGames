...
public class SettingsConstants {
    ...
    public static Integer WORLD_SIZE_ID = 0;
    ...
    public static Integer NUM_GOALS_ID = 1;
    ...
    public static Integer PVP_ID = 2;
    ...
    public static Integer DIFFICULTY_ID = 3;
    ...
    public static Integer HUNGER_ID = 4;
    ...
    public static Integer PLAYER_SPREAD_RADIUS_ID = 5;
    ...
    public static Integer PLAYER_SPREAD_ID = 6;
