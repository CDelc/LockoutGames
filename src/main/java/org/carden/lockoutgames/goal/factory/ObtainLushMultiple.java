...
public class ObtainLushMultiple extends ObtainSubsetOrFullSetOfItems {
    ...
    public ObtainLushMultiple() {
        super(GoalConstants.LUSH_BLOCKS.keySet(), SUBSET_PERCENT_CHANCE, STACK_PERCENT_CHANCE, SUBSET_MIN_SIZE, SUBSET_MAX_SIZE, MIN_STACK_SIZE, MAX_STACK_SIZE, "lush block", GoalDifficulty.MEDIUM);
