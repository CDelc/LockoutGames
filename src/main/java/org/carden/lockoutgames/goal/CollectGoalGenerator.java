...
public enum CollectGoalGenerator implements GoalGenerator {
    ...
    SHOVEL(new Material[]{Material.WOODEN_SHOVEL, Material.STONE_SHOVEL, Material.IRON_SHOVEL, Material.GOLDEN_SHOVEL, Material.DIAMOND_SHOVEL, Material.NETHERITE_SHOVEL},
            Option.OR, RNGSettings.SINGLE, 0),
    COBBLESTONE(new Material[]{Material.COBBLESTONE}, Option.OR, RNGSettings.STACKPLUS, 1),
    SPORE_BLOSSOM(new Material[]{Material.SPORE_BLOSSOM}, Option.OR, RNGSettings.SINGLE, 2),
    AZALEA(new Material[]{Material.FLOWERING_AZALEA, Material.AZALEA}, Option.OR, RNGSettings.SINGLE, 2),
    ...
    COAL(new Material[]{Material.COAL}, Option.OR, RNGSettings.MOST_STACK, 1),
    ...
    AMETHYST_SHARD(new Material[]{Material.AMETHYST_SHARD}, Option.OR, RNGSettings.SMALL_HANDFUL, 2),
    CALCITE(new Material[]{Material.CALCITE}, Option.OR, RNGSettings.LARGE_HANDFUL, 2),
    SPYGLASS(new Material[]{Material.SPYGLASS}, Option.OR, RNGSettings.SINGLE, 2),
    TINTED_GLASS(new Material[]{Material.TINTED_GLASS}, Option.OR, RNGSettings.SMALL_HANDFUL, 2),
    AMETHYST_BLOCK(new Material[]{Material.AMETHYST_BLOCK}, Option.OR, RNGSettings.LARGE_HANDFUL, 2),
    DIAMOND(new Material[]{Material.DIAMOND}, Option.OR, RNGSettings.MED_HANDFUL, 2),
    DIAMOND_PICKAXE(new Material[]{Material.DIAMOND_PICKAXE}, Option.OR, RNGSettings.SINGLE, 2),
    ALL_METAL_BLOCKS(new Material[]{Material.COAL_BLOCK, Material.COPPER_BLOCK, Material.IRON_BLOCK, Material.GOLD_BLOCK, Material.REDSTONE_BLOCK, Material.LAPIS_BLOCK, Material.DIAMOND_BLOCK, Material.EMERALD_BLOCK},
            Option.AND, RNGSettings.SINGLE, 3),
    ALL_METAL_HARD(new Material[]{Material.COAL_BLOCK, Material.COPPER_BLOCK, Material.IRON_BLOCK, Material.GOLD_BLOCK, Material.REDSTONE_BLOCK, Material.LAPIS_BLOCK, Material.DIAMOND_BLOCK, Material.EMERALD_BLOCK, Material.NETHERITE_BLOCK},
            Option.AND, RNGSettings.SINGLE, 4),
